"use strict";
/**
 * Тесты для Value Object: Balance
 */
...
describe('Domain Layer - Value Object: Balance', () => {
    ...
    describe('subtract', () => {
        it('should subtract balance amounts', () => {
            const balance1 = Balance_1.Balance.create(10000); // $100
            const balance2 = Balance_1.Balance.create(3000); // $30
        ...
        it('should throw error when result would be negative', () => {
            const balance1 = Balance_1.Balance.create(5000); // $50
            const balance2 = Balance_1.Balance.create(10000); // $100
            expect(() => balance1.subtract(balance2)).toThrow('Insufficient balance');
        });
        it('should not mutate original balance', () => {
            const balance1 = Balance_1.Balance.create(10000);
            const balance2 = Balance_1.Balance.create(3000);
    ...
    describe('isGreaterThanOrEqual', () => {
        ...
        it('should return true when balance is equal', () => {
            const balance1 = Balance_1.Balance.create(10000);
            const balance2 = Balance_1.Balance.create(10000);
            expect(balance1.isGreaterThanOrEqual(balance2)).toBe(true);
        });
    ...
    describe('toString', () => {
        it('should return formatted string with dollar sign', () => {
            const balance = Balance_1.Balance.create(10050); // $100.50
