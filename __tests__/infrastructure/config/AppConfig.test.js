...
describe('Infrastructure Layer - Config: AppConfig', () => {
    describe('createAppConfig - basic functionality', () => {
        it('should create app config from env config', () => {
            ...
            const appConfig = (0, infrastructure_1.createAppConfig)(envConfig);
    ...
    describe('payments config - amount and currency', () => {
        ...
        it('should have same payment settings regardless of stripe token', () => {
            ...
            const configWith = (0, infrastructure_1.createAppConfig)(envWithStripe);
            const configWithout = (0, infrastructure_1.createAppConfig)(envWithoutStripe);
    ...
    describe('config immutability', () => {
        it('should create new config for each call', () => {
            ...
            const config1 = (0, infrastructure_1.createAppConfig)(envConfig);
            const config2 = (0, infrastructure_1.createAppConfig)(envConfig);
